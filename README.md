...
| **AI & APIs**       | [OpenAI API](https://openai.com/), [DeepSeek API](https://api-docs.deepseek.com/), [GitHub API](https://docs.github.com/en/rest)                         |
...
3.  **Set up your environment variables:**
    ...
    - Get your DeepSeek API Key from [platform.deepseek.com](https://platform.deepseek.com/api_keys).
